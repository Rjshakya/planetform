/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 28d9cada468e16bba24605f162043ec5)
// Runtime types generated with workerd@1.20260120.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/app");
	}
	interface Env {
		planetform_kv: KVNamespace;
		HYPERDRIVE: Hyperdrive;
		planetform_integrations_queue: Queue;
		MY_GENERAL_LIMITER: RateLimit;
		MY_WORKFLOWS_LIMITER: RateLimit;
		MY_RESPONDENT_LIMITER: RateLimit;
		MY_SUBMISSIONS_LIMITER: RateLimit;
		MY_GMAIL_LIMITER: RateLimit;
		WRKSPACE_UPLOAD_LIMITER: RateLimit;
		RESPONDENT_UPLOAD_LIMITER: RateLimit;
		...
		POLAR_ORG_ID: string;
		PLANETFORM_EMAIL_NOTIFICATION_ADDRESS: string;
		NODE_ENV: string;
		GMAIL_INTEGRATION_WORKFLOW: Workflow<Parameters<import("./src/app").GmailIntegrationWorkflow['run']>[0]['payload']>;
		GOOGLE_SHEET_INTEGRATION_WORKFLOW: Workflow<Parameters<import("./src/app").GoogleSheetIntegrationWorkflow['run']>[0]['payload']>;
		NOTION_INTEGRATION_WORKFLOW: Workflow<Parameters<import("./src/app").NotionIntegrationWorkflow['run']>[0]['payload']>;
		WEBHOOK_INTEGRATION_WORKFLOW: Workflow<Parameters<import("./src/app").WebHookIntegrationWorkflow['run']>[0]['payload']>;
		SLACK_INTEGRATION_WORKFLOW: Workflow<Parameters<import("./src/app").SlackIntegrationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BUCKET_NAME" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_ENDPOINT" | "R2_DOMAIN" | "CLOUDFLARE_ACCOUNT_ID" | "DATABASE_URL" | "DODO_PAYMENTS_API_KEY" | "DODO_PAYMENTS_WEBHOOK_SECRET" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "NOTION_CLIENT_ID" | "NOTION_CLIENT_SECRET" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "RESEND_API_KEY" | "TRUSTED_DOMAIN" | "FRONTEND_URL" | "POLAR_ACCESS_TOKEN" | "PRO_PLAN_PRODUCT_ID" | "POLAR_ORG_ID" | "PLANETFORM_EMAIL_NOTIFICATION_ADDRESS" | "NODE_ENV">> {}
}
