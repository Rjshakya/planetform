/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9a69e9c4773dffc85278dfb5212d6dea)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GOOGLE_SHEET_FLOW: Workflow<Parameters<import("./src/app").GoogleSheetWorkflow['run']>[0]['payload']>;
		MANAGER_WORK_FLOW: Workflow<Parameters<import("./src/app").ManagerWorkflow['run']>[0]['payload']>;
		NOTION_PAGE_CREATE_WORK_FLOW: Workflow<Parameters<import("./src/app").NotionPageCreateWorkflow['run']>[0]['payload']>;
		NOTION_SUBMISSION_WORK_FLOW: Workflow<Parameters<import("./src/app").NotionSubmissionWorkflow['run']>[0]['payload']>;
		WEBHOOK_WORK_FLOW: Workflow<Parameters<import("./src/app").WebHookFlow['run']>[0]['payload']>;
		GMAIL_NOTIFY_WORK_FLOW: Workflow<Parameters<import("./src/app").PersonalGmailNotifyFlow['run']>[0]['payload']>;
		DODO_CUSTOMER_CREATE_WORK_FLOW: Workflow<Parameters<import("./src/app").DodoCustomerCreateFlow['run']>[0]['payload']>;
		GMAIL_WORK_FLOW: Workflow<Parameters<import("./src/app").GmailWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FRONTEND_URL" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "NOTION_CLIENT_ID" | "NOTION_CLIENT_SECRET" | "DODO_PAYMENTS_API_KEY" | "DODO_PAYMENTS_WEBHOOK_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_ENDPOINT" | "BUCKET_NAME" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_DOMAIN" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "NODE_ENV" | "TRUSED_DOMAIN" | "RESEND_API_KEY">> {}
}
