...
export class SubscriptionServiceError extends TaggedError(
  ...
  constructor(args: { operation: string; cause: unknown }) {
    ...
    super({
      ...args,
      message: `Subscription ${args.operation} failed: ${msg}`,
    });
  }
}

export class WorkspaceServiceError extends TaggedError(
