/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 18321f0422379af0309f73f18109a773)
// Runtime types generated with workerd@1.20260120.0 2026-05-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VITE_BACKEND_URL: string;
		VITE_CLIENT_URL: string;
		VITE_GOOGLE_FONT_API_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_BACKEND_URL" | "VITE_CLIENT_URL" | "VITE_GOOGLE_FONT_API_KEY">> {}
}
