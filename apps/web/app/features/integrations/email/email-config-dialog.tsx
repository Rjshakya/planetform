  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <Button onClick={handleConnectButton} variant={"secondary"}>Connect</Button>
        <DialogContent>
          <DialogHeader>
      ...
      <UpgradeModal isOpen={openUpgradeModel} onClose={() => setOpenUpgradeModel(false)} feature="Email Integration" />
    </>
  );
};
