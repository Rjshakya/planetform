...
function TiptapImage(props: NodeViewProps) {
  ...
  return (
    <NodeViewWrapper
      ref={nodeRef}
      className={cn(
        "relative flex flex-col rounded-md border-2 border-transparent p-1",
      ...
      >
        ...
        {editor?.isEditable && (
          <>
            ...
            >
              <div className="z-20 h-17.5 w-1 rounded-xl border bg-orange-500 opacity-0 transition-all group-hover:opacity-100" />
            </div>
            <div
