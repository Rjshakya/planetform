...
export const Hero = () => {
  ...
  return (
    ...
    >
      <MarketingContainer className="relative z-10 bg-background py-12 grid gap-8">
        ...
        <div className="bg-input relative hero-img md:p-40 sm:p-28 p-20 pt-24 md:h-150 sm:h-100 h-62 overflow-hidden rounded-2xl md:mt-28 mt-12">
          <img
            src="/hero.png"
