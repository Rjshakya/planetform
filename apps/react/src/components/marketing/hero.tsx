    ...
    <section id="hero" className="w-full relative overflow-hidden pt-36 ">
      <div className="grid gap-4">
        ...
        <div className={`md:px-20 px-2`}>
          <h1 className="landing-heading mb-4">
            Make
            <Button className="mx-2" variant={"outline"} size={"icon-xs"}>
              <svg
                role="icon"
                xmlns="http://www.w3.org/2000/svg"
                className="size-5 fill-emerald-400"
                viewBox="0 0 24 24"
                fill="#fff"
              >
            ...
            users actually
            <Button variant={"outline"} size={"icon-xs"} className="mx-2">
              <svg
                role="icon"
                xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Subheading */}
          <p className="landing-sub-heading  mb-8">
        ...
        <div className="w-full">
          <div className="h-6 md:h-8 w-full  text-muted-foreground/40 dark:text-accent bg-size-[8px_8px] bg-top-left bg-[repeating-linear-gradient(315deg,currentColor_0,currentColor_1px,transparent_0,transparent_50%)]" />
          <div
            className="w-full h-[500px] relative overflow-y-auto px-4  md:px-8 text-muted-foreground/40 dark:text-accent bg-size-[8px_8px] bg-top-left bg-[repeating-linear-gradient(315deg,currentColor_0,currentColor_1px,transparent_0,transparent_50%)] "
